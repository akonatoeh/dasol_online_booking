                    ...
                    <tbody>
                        ...
                        @if ($data->type == 'Activity')
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="{{url('update_activities',$data->id)}}">Update</a>
                                </td>
                                <td>
                                    <a onclick="return confirm('Are you sure to delete this?');" class="btn btn-danger" href="{{url('activity_delete',$data->id)}}">Delete</a>
                                </td>
