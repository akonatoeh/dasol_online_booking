                        ...
                        <tbody>
                            @foreach ($data as $data)
                                <tr>
                                    ...
                                    <td><a onclick="return confirm('Are you sure to delete this?');" class="btn btn-danger" href="{{ url('tour_delete', $data->id) }}" data-toggle="tooltip" title="Delete this tour permanently">
                                        Delete
                                    </a></td>
                                </tr>
                            @endforeach
