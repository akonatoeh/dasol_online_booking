            ...
            <ul class="list-unstyled">
                ...
                <li><a href="#tours_dropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>TOURS & ACTIVITIES</a>
                    <ul id="tours_dropdown" class="collapse list-unstyled ">
                        ...
                        <li  class="active"><a href="{{url('view_activities')}}">View Activities</a></li>
                    </ul>
                </li>
                        ...
                        <div class="available-dates">
                            ...
                            <div id="datePreview" class="date-grid">
                                ...
                                <div class="button-group" style="padding-top: 20px">
                                    <a class="btn btn-warning" href="{{ url('toggle.status', $data->id) }}" data-toggle="tooltip" title="Change the status of the activity (In Service or Out of Service)">
                                        {{ $data->status === 'In Service' ? 'In Service' : 'Out of Service' }}
                                    </a>
                                    <a class="btn btn-warning" href="{{ url('update_activities', $data->id) }}" data-toggle="tooltip" title="Edit the activity details">
                                        Update
                                    </a>
                                    <a onclick="return confirm('Are you sure to delete this?');" class="btn btn-danger" href="{{ url('activity_delete', $data->id) }}" data-toggle="tooltip" title="Delete this activity permanently">
                                        Delete
                                    </a>
                                </div>
                            </div>
