    ...
    <div class="page-content">
        <div class="container-fluid">
            <div style="text-align: center;margin-bottom: 20px; padding-top: 20px;">
                <h1 style="color: blue; font-weight: bold;  font-size: 2em;">View Room Tickets</h1>
            </div>
    ...
    @endphp
                    <tr>
                        ...
                        <td>
                                    ...
                                    <a class="btn btn-warning" href="{{ url('toggle_status', $booking->id) }}" data-toggle="tooltip" title="Click this button to Change the status of the booking (Ongoing or Finished)">
