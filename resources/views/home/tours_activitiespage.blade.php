...
.form-select {
   ...
   <body class="main-layout">
      ...
      <div class="header">
         <div class="container">
            <div class="row">
               ...
               <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-sm-9 col-sm-9">
      ...
      <div class="back_re">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="title">
                     <h2>Book Tours and Activities Now</h2>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="ourroom">
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <form style="padding-top: 10px;" method="GET" action="{{ url('tours_activities_page') }}" class="d-flex flex-row-reverse">
            ...
            <div class="row">
             ...
             <div class="pagination">
                ...
                @else
                    <a href="{{ $datas->previousPageUrl() }}" class="previous">Previous</a>
                @endif
                ...
                @if ($datas->hasMorePages())
                    <a href="{{ $datas->nextPageUrl() }}" class="next">Next</a>
                @else
